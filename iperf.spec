...
Version  : 3.12
Release  : 24
URL      : https://github.com/esnet/iperf/archive/3.12/iperf-3.12.tar.gz
Source0  : https://github.com/esnet/iperf/archive/3.12/iperf-3.12.tar.gz
...
%prep
%setup -q -n iperf-3.12
cd %{_builddir}/iperf-3.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664814484
