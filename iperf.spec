...
Source0  : https://github.com/esnet/iperf/archive/3.10/iperf-3.10.tar.gz
...
%prep
%setup -q -n iperf-3.10
cd %{_builddir}/iperf-3.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622127398
...
cp %{_builddir}/iperf-3.10/docs/_esnet/LICENSE %{buildroot}/usr/share/package-licenses/iperf/2710606f6db128e7cf24e84572811bbf177a4ce9
%make_install
