...
Version  : 3.16
Release  : 29
URL      : https://github.com/esnet/iperf/archive/3.16/iperf-3.16.tar.gz
Source0  : https://github.com/esnet/iperf/archive/3.16/iperf-3.16.tar.gz
...
%prep
%setup -q -n iperf-3.16
cd %{_builddir}/iperf-3.16
pushd ..
cp -a iperf-3.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701972950
...
/usr/share/package-licenses/iperf/e5a1f89b6acd769bd4c769cabaaa7db3c039074a
