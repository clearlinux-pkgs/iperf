...
Version  : 3.8.1
Release  : 20
URL      : https://github.com/esnet/iperf/archive/3.8.1/iperf-3.8.1.tar.gz
Source0  : https://github.com/esnet/iperf/archive/3.8.1/iperf-3.8.1.tar.gz
...
%prep
%setup -q -n iperf-3.8.1
cd %{_builddir}/iperf-3.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595290226
...
cp %{_builddir}/iperf-3.8.1/docs/_esnet/LICENSE %{buildroot}/usr/share/package-licenses/iperf/2710606f6db128e7cf24e84572811bbf177a4ce9
%make_install
