...
Version  : 3.19
Release  : 33
URL      : https://github.com/esnet/iperf/archive/3.19/iperf-3.19.tar.gz
Source0  : https://github.com/esnet/iperf/archive/3.19/iperf-3.19.tar.gz
...
%prep
%setup -q -n iperf-3.19
cd %{_builddir}/iperf-3.19
pushd ..
cp -a iperf-3.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748368905
